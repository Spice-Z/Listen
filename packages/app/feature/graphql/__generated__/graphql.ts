...
export type Episode = Node & {
  __typename?: 'Episode';
  canDirection: Scalars['Boolean']['output'];
...
export type GetEpisodeQuery = { __typename?: 'Query', episode: { __typename?: 'Episode', id: string, episodeId: string, title: string, content: string, url: string, imageUrl: string, duration: number, pubDate: number, hasChangeableAd: boolean, transcriptUrl?: string | null, canDirection: boolean, translatedTranscripts: Array<{ __typename?: 'TranslatedTranscript', language: string, transcriptUrl: string }> } };
...
export type GetEpisodeInCurrentEpisodeDataQuery = { __typename?: 'Query', episode: { __typename?: 'Episode', id: string, transcriptUrl?: string | null, hasChangeableAd: boolean, canDirection: boolean, translatedTranscripts: Array<{ __typename?: 'TranslatedTranscript', language: string, transcriptUrl: string }> } };
